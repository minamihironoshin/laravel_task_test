    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <br>
                <div class="lg:w-2/3 mx-auto pb-8" >
                  <a href="{{ route('contacts.create') }}" class="text-blue-500 border-b-2 border-blue-500">お問い合わせの入力はこちら</a>
                </div>
                <form method="get" action="{{ route('contacts.index') }}" class="lg:w-2/3 mx-auto">
                  ...
                  <table class="table-auto w-full text-left whitespace-no-wrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="border-t-2 border-gray-200 px-4 py-3 text-lg text-gray-900"><a href="{{ route('contacts.show',['id' => $contact->id ]) }}" class="text-blue-500">詳細を見る</td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
